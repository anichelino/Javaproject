...
public class MainExecutor {
    public static void main(String[] args) {
       ...
       // Order order1= new Order(order1Products,1,new GregorianCalendar(2014, Calendar.FEBRUARY, 11).getTime());
        ...
        System.out.println("------------------------------------ ");
        Long collected = order1Products.stream().collect(Collectors.counting());
        Map<String, Double> collectTypePrice = order2Products.stream().collect(Collectors.toMap(Product::getName, Product::getPrice));

        System.out.println("collected counting "+collected);
        System.out.println("------------------------------------ ");
        System.out.println("collected order type-price "+collectTypePrice);
        System.out.println("------------------------------------ ");
        String collectedProductsName = order3Products.stream().map(Product::getName).collect(Collectors.joining("--"));
        System.out.println("collectedProductsName "+collectedProductsName);
        System.out.println("------------------------------------ ");
        ...
        System.out.println("------------------------------------ ");
        Optional<Double> collectMax = order5Products.stream().map(Product::getPrice).collect(Collectors.maxBy(comparator));
        System.out.println("collectMax= "+collectMax);
        System.out.println("------------------------------------ ");
        Double collectSum = order7Products.stream().collect(Collectors.summingDouble(Product::getPrice));
        System.out.println("collectSum= "+collectSum);
        System.out.println("------------------------------------ ");
        DoubleSummaryStatistics collectStats = order8Products.stream().collect(Collectors.summarizingDouble(Product::getPrice));
        System.out.println("collectStatsAvg= "+collectStats.getAverage());
        System.out.println("collectStatsMax= "+collectStats.getMax());
        System.out.println("collectStatsMin= "+collectStats.getMin());
        System.out.println("------------------------------------ ");
        Map<String, List<Product>> stringListMap = order4Products.stream().collect(Collectors.groupingBy(Product::getType));
        System.out.println(stringListMap);
        System.out.println("------------------------------------ ");
        Map<Boolean, List<Product>> booleanPrice = order2Products.stream().collect(Collectors.partitioningBy(product -> product.getPrice() > 600));
        System.out.println(booleanPrice);
